...
public final class KingSafetyAnalyzer {
    ...
    private static final com.chess.engine.classic.player.ai.KingSafetyAnalyzer INSTANCE = new com.chess.engine.classic.player.ai.KingSafetyAnalyzer();
    private static final List<List<Boolean>> COLUMNS = initColumns();

    private KingSafetyAnalyzer() {
    }

    public static com.chess.engine.classic.player.ai.KingSafetyAnalyzer get() {
        return INSTANCE;
    }
    ...
    public com.chess.engine.classic.player.ai.KingSafetyAnalyzer.KingDistance calculateKingTropism(final Player player) {
        ...
        return new com.chess.engine.classic.player.ai.KingSafetyAnalyzer.KingDistance(closestPiece, closestDistance);
    }
