...
public class StockAlphaBeta extends Observable implements MoveStrategy {
    ...
    public Move execute(final Board board) {
        ...
        for (final Move move : com.chess.engine.classic.player.ai.StockAlphaBeta.MoveSorter.EXPENSIVE.sort((board.currentPlayer().getLegalMoves()))) {
    ...
    private int max(final Board board,
        ...
        for (final Move move : com.chess.engine.classic.player.ai.StockAlphaBeta.MoveSorter.STANDARD.sort((board.currentPlayer().getLegalMoves()))) {
            final MoveTransition moveTransition = board.currentPlayer().makeMove(move);
            if (moveTransition.getMoveStatus().isDone()) {
