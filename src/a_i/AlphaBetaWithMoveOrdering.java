...
public class AlphaBetaWithMoveOrdering extends Observable implements MoveStrategy {
    ...
    private final com.chess.engine.classic.player.ai.AlphaBetaWithMoveOrdering.MoveSorter moveSorter;
    ...
    public AlphaBetaWithMoveOrdering(final int searchDepth,
        ...
        this.moveSorter = com.chess.engine.classic.player.ai.AlphaBetaWithMoveOrdering.MoveSorter.SORT;
