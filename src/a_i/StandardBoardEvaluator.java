...
public final class StandardBoardEvaluator
    ...
    private static final com.chess.engine.classic.player.ai.StandardBoardEvaluator INSTANCE = new com.chess.engine.classic.player.ai.StandardBoardEvaluator();

    private StandardBoardEvaluator() {
    }

    public static com.chess.engine.classic.player.ai.StandardBoardEvaluator get() {
        return INSTANCE;
    }
    ...
    private static int kingSafety(final Player player) {
        final com.chess.engine.classic.player.ai.KingSafetyAnalyzer.KingDistance kingDistance = KingSafetyAnalyzer.get().calculateKingTropism(player);
