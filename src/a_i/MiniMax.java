...
public final class MiniMax implements MoveStrategy {
    ...
    private com.chess.engine.classic.player.ai.MiniMax.FreqTableRow[] freqTable;
    ...
    public Move execute(final Board board) {
        ...
        this.freqTable = new com.chess.engine.classic.player.ai.MiniMax.FreqTableRow[board.currentPlayer().getLegalMoves().size()];
        ...
        for (final Move move : board.currentPlayer().getLegalMoves()) {
            ...
            if (moveTransition.getMoveStatus().isDone()) {
                final com.chess.engine.classic.player.ai.MiniMax.FreqTableRow row = new com.chess.engine.classic.player.ai.MiniMax.FreqTableRow(move);
        ...
        long total = 0;
        for (final com.chess.engine.classic.player.ai.MiniMax.FreqTableRow row : this.freqTable) {
            if(row != null) {
                total += row.getCount();
            }
        }
