...
public final class PawnStructureAnalyzer {
    ...
    private static final com.chess.engine.classic.player.ai.PawnStructureAnalyzer INSTANCE = new com.chess.engine.classic.player.ai.PawnStructureAnalyzer();
    ...
    public static com.chess.engine.classic.player.ai.PawnStructureAnalyzer get() {
        return INSTANCE;
    }
